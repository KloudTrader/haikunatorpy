...
"zhukovsky",
    ...
    def __init__(self, seed=None, adjectives=None, nouns=None, qualities=None, persons=None):
        """
    ...
    def haikunate(self, delimiter='-', token_length=4, token_hex=False, token_chars='0123456789'):
        ...
        if bool(secrets.randbits(1)):
            ...
            adjective = self._random_element(self._qualities)
            noun = self._random_element(self._persons)
